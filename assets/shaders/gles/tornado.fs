...
// // Fractal Brownian Motion 3D (3 octaves)
// float fbm3D(vec3 p) {
//     float v = 0.0;
//     float a = 0.5;
...
//     // Tối ưu hóa: Giảm số bước chạy raymarching từ 22 xuống 15 để chạy mượt mà trên mobile
//     float stepSize = (2.0 * zLimit) / 15.0;
...
//     // === PHỐI MÀU LỐC XOÁY ÁNH SÁNG THẦN THOẠI ===
...
//     finalRGB += coreLight * accumulatedCore * (0.75 + 0.25 * sin(time * 25.0));

//     // Tăng cường độ phát sáng
//     finalRGB *= 1.35;

//     // === HÀO QUANG VÀ GIỚI HẠN BIÊN ===
